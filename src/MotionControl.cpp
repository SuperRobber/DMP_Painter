    ...
    switch (activeState) {
        ...
        case state_home: {
            if (!isHome) {
                ...
                if (requestedState == state_home) requestedState = state_none;
                activeState = state_none;
